...
\pnum
A local parameter shall only appear as an \deflink{unevaluated operand}{expr.context}
...
that is not a subexpression of a nested \deflink{unevaluated operand}{expr.context}.
\end{itemize}
